...
<body>
  ...
  <div class="container" role="region" aria-labelledby="new-student-title">
    <div class="hero" aria-hidden="false">
      <h1 id="new-student-title">Update Student</h1>
    ...
    <div class="form-wrap">
      <form id="newStudentForm" action="updateStudent" method="post" novalidate>
        <div class="row two-col" style="margin-bottom:12px">
          <div class="form-group">
            <label for="firstName">First name</label>
            <input class="input" id="firstName" value="${student.firstName}" name="firstName" type="text" placeholder="Enter first name" required minlength="2" />
            <div class="error" id="err-firstName" style="display:none"></div>
          </div>

          <div class="form-group">
            <label for="lastName">Last name</label>
            <input class="input" id="lastName" name="lastName" value="${student.lastName }" type="text" placeholder="Enter last name" required minlength="2" />
        ...
        <div class="form-group">
          ...
          <input class="input" id="email" name="email" type="email" value="${student.email}" placeholder="example@student.com" required />
